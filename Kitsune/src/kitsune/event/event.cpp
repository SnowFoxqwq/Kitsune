...
//add support for event output in spdlog
template<typename T> struct fmt::formatter<T, std::enable_if_t<std::is_base_of_v<kitsune::Event, T>, char>> : fmt::formatter<std::string>
{
